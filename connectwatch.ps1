# --- CONFIGURATION ---
$TargetHost        = "8.8.8.8"
$LogFile           = "CC:\Users\micha\OneDrive\Documents\ConnectWatch\ConnectWatch_Log.txt" # Change this path if needed
...
Write-Host "Starting ConnectWatch ping monitor for $TargetHost..." -ForegroundColor Cyan
